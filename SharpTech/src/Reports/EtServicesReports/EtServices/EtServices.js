                ...
                <center>
                  <table className='et-service-form-table-1' style={{ border: '2px solid black', borderCollapse: 'collapse' }}>
                    ...
                    <tr>
                      ...
                      <td className='et-service-form-table-1-data' colSpan={4} style={{ border: '1px solid black' }}>
                        <input type="text" className="et-service-input-labels" placeholder="Enter  Deed Type" name="deedType" style={{ width: '100%' }} onChange={(e) => handleInputChange(e, table.id)} />
                      </td>
                      <th className='et-service-form-table-1-heading' style={{ border: '1px solid black' }}> Consideration Amount: </th>
                      <td className='et-service-form-table-1-data' colSpan={'100%'} style={{ border: '1px solid black' }}>
                        <input type="text" className="et-service-input-labels" placeholder="Enter Consideration Amount" name="considerationAmount" style={{ width: '100%' }} onChange={(e) => handleInputChange(e, table.id)} />
                      </td>
                    </tr>
